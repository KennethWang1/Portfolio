...
function ProjectDiv({content, link, img = "https://placehold.co/800x500", title = "Placeholder"}) {
    return(
        <div className= 'items-left rounded-lg bg-dark w-80 h-99 m-10 p-2 pt-0 pb-0'>
            ...
            <div className='w-full h-40 bg-cyan-100 mt-4 mb-4 rounded-lg overflow-hidden flex flex-col items-center'>
                <a href = {link} rel="noopener noreferrer" target="_blank" className='relative w-fit underline decoration-dark text-center pl-2 text-background text-2xl overflow-hidden'>{title}</a>
