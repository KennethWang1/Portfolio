...
function ProjectDiv({content, link, img = "https://placehold.co/800x500", title = "Placeholder"}) {
    return(
        <div className= 'items-left rounded-lg bg-dark w-80 h-89 m-10 p-2 pt-0 pb-0'>
            ...
            <div className='w-full h-30 bg-cyan-100 mt-4 mb-4 rounded-lg overflow-hidden'>
