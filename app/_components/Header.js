...
export default function Header() {
    return (
        <header className="w-full h-20 bg-gradient-to-b from-background via-background to-transparent gradient-header flex flex-row justify-center items-top text-2xl underline z-10">
